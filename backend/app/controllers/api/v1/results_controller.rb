    ...
    class ResultsController < ApplicationController
      def index
        relation = Result
          ...
          .order(year: :desc, competition_name: :asc, event_name: :asc, final_group: :asc, rank: :asc)
      ...
      def filters
        ...
        render json: {
          ...
          final_groups: base
            ...
            .by_event(params[:event])
            .by_organization(params[:organization])
            .distinct.order(:final_group).pluck(:final_group),
          competitions: base
            .by_year(params[:year])
            .by_gender(params[:gender])
            .by_affiliation_type(params[:affiliation_type])
            ...
            .by_final_group(params[:final_group])
            .by_organization(params[:organization])
            .distinct.order(:competition_name).pluck(:competition_name),
          events: base
            .by_year(params[:year])
            .by_gender(params[:gender])
            .by_affiliation_type(params[:affiliation_type])
            ...
            .by_final_group(params[:final_group])
            .by_organization(params[:organization])
            .distinct.order(:event_name).pluck(:event_name),
          organizations: base
            .by_year(params[:year])
            .by_gender(params[:gender])
            .by_affiliation_type(params[:affiliation_type])
            ...
            .by_event(params[:event])
            .by_final_group(params[:final_group])
            .distinct.order(:organization).pluck(:organization),
          affiliation_types: base
            .by_year(params[:year])
            .by_gender(params[:gender])
            .by_competition(params[:competition])
            .by_event(params[:event])

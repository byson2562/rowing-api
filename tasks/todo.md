...
## メディア記事によるSEO強化 (2026-07-21起票・未着手)

### Plan
- [ ] 1. ブログ基盤の実装: `/articles` セクション(一覧+記事ページ、Article構造化データ、sitemap組み込み、OG対応)
- [ ] 2. 1本目: 自前データ分析記事のドラフト「データで見る大学ボート勢力図(過去17年)」— 5,400レースのDBから集計、図表付き

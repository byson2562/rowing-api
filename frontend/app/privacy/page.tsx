...
export default function PrivacyPage() {
  return (
    <main className="site-container lp-page">
      ...
      <section className={lpDetail} aria-labelledby="privacy-analytics-heading">
        <h2 id="privacy-analytics-heading" className={`lp-section-title ${lpDetailTitle}`}>
          アクセス解析ツールについて
        </h2>
      ...
      <section className={lpDetail} aria-labelledby="privacy-ads-heading">
        <h2 id="privacy-ads-heading" className={`lp-section-title ${lpDetailTitle}`}>
          広告について
        </h2>
        <div className={lpDetailCard}>
          <p>
      ...
      <section className={lpDetail} aria-labelledby="privacy-data-heading">
        <h2 id="privacy-data-heading" className={`lp-section-title ${lpDetailTitle}`}>
          掲載データについて
        </h2>
        <div className={lpDetailCard}>
          <p>
      ...
      <section className={lpDetail} aria-labelledby="privacy-payment-heading">
        <h2 id="privacy-payment-heading" className={`lp-section-title ${lpDetailTitle}`}>
          寄付・決済について
        </h2>
        <div className={lpDetailCard}>
          <p>
      ...
      <section className={lpDetail} aria-labelledby="privacy-disclaimer-heading">
        <h2 id="privacy-disclaimer-heading" className={`lp-section-title ${lpDetailTitle}`}>
          免責事項
        </h2>
        <div className={lpDetailCard}>
          <p>
      ...
      <section className={lpDetail} aria-labelledby="privacy-contact-heading">
        <h2 id="privacy-contact-heading" className={`lp-section-title ${lpDetailTitle}`}>
          お問い合わせ
        </h2>
        <div className={lpDetailCard}>
          <p>
